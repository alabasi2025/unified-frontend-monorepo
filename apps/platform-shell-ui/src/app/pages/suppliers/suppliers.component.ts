    ...
    <div class="page-container">
      ...
      <div class="page-header">
        <div class="header-content">
          ...
          <div class="header-text">
            <h1>الموردين</h1>
            <p>إدارة الموردين في النظام</p>
          </div>
        </div>
        <button pButton label="إضافة المورد" icon="pi pi-plus" class="add-btn" (click)="openNew()"></button>
      </div>
      ...
      <div class="table-container">
        <p-table [value]="filteredItems" [loading]="loading" [paginator]="true" [rows]="10" 
                 ...
                 currentPageReportTemplate="عرض {first} إلى {last} من {totalRecords} المورد"
            ...
            <tr>
              <td colspan="4" class="empty-message">
                <div class="empty-state">
                  ...
                  <p>لم يتم العثور على الموردين</p>
                </div>
              </td>
            </tr>
          </ng-template>
...
export class SuppliersComponent implements OnInit {
  ...
  openNew() {
    this.item = {};
    this.dialogTitle = 'إضافة المورد جديد';
    this.itemDialog = true;
  }

  editItem(item: any) {
    this.item = { ...item };
    this.dialogTitle = 'تعديل المورد';
    this.itemDialog = true;
  }
