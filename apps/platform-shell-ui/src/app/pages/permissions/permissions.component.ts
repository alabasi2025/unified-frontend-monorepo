    ...
    <div class="page-container">
      ...
      <div class="page-header">
        <div class="header-content">
          ...
          <div class="header-text">
            <h1>الصلاحيات</h1>
            <p>إدارة الصلاحيات في النظام</p>
          </div>
        </div>
        <button pButton label="إضافة الصلاحية" icon="pi pi-plus" class="add-btn" (click)="openNew()"></button>
      </div>
      ...
      <div class="table-container">
        <p-table [value]="filteredItems" [loading]="loading" [paginator]="true" [rows]="10" 
                 ...
                 currentPageReportTemplate="عرض {first} إلى {last} من {totalRecords} الصلاحية"
            ...
            <tr>
              <td colspan="4" class="empty-message">
                <div class="empty-state">
                  ...
                  <p>لم يتم العثور على الصلاحيات</p>
                </div>
              </td>
            </tr>
          </ng-template>
...
export class PermissionsComponent implements OnInit {
  ...
  openNew() {
    this.item = {};
    this.dialogTitle = 'إضافة الصلاحية جديد';
    this.itemDialog = true;
  }

  editItem(item: any) {
    this.item = { ...item };
    this.dialogTitle = 'تعديل الصلاحية';
    this.itemDialog = true;
  }
