    ...
    <div class="page-container">
      ...
      <div class="page-header">
        <div class="header-content">
          ...
          <div class="header-text">
            <h1>الأدوار</h1>
            <p>إدارة الأدوار في النظام</p>
          </div>
        </div>
        <button pButton label="إضافة الدور" icon="pi pi-plus" class="add-btn" (click)="openNew()"></button>
      </div>
      ...
      <div class="table-container">
        <p-table [value]="filteredItems" [loading]="loading" [paginator]="true" [rows]="10" 
                 ...
                 currentPageReportTemplate="عرض {first} إلى {last} من {totalRecords} الدور"
...
export class RolesComponent implements OnInit {
  ...
  openNew() {
    this.item = {};
    this.dialogTitle = 'إضافة الدور جديد';
    this.itemDialog = true;
  }

  editItem(item: any) {
    this.item = { ...item };
    this.dialogTitle = 'تعديل الدور';
    this.itemDialog = true;
  }
