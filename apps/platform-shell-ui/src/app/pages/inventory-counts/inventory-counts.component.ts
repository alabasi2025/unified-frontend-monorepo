    ...
    <div class="page-container">
      ...
      <div class="page-header">
        <div class="header-content">
          <div class="header-icon">
            <i class="pi-sitemap"></i>
          </div>
          <div class="header-text">
            <h1>الوحدات</h1>
            <p>إدارة الوحدات في النظام</p>
          </div>
        </div>
        <button pButton label="إضافة الوحدة" icon="pi pi-plus" class="add-btn" (click)="openNew()"></button>
      </div>
      ...
      <div class="table-container">
        <p-table [value]="filteredItems" [loading]="loading" [paginator]="true" [rows]="10" 
                 ...
                 currentPageReportTemplate="عرض {first} إلى {last} من {totalRecords} الوحدة"
...
export class UnitsComponent implements OnInit {
  ...
  openNew() {
    this.item = {};
    this.dialogTitle = 'إضافة الوحدة جديد';
    this.itemDialog = true;
  }

  editItem(item: any) {
    this.item = { ...item };
    this.dialogTitle = 'تعديل الوحدة';
    this.itemDialog = true;
  }
